...
| Offline SCORM                                        | [0041](../adr/0041-progressive-web-app-and-offline-scorm-delivery.md), [0042](../adr/0042-device-bound-offline-learning-entitlements.md), [0043](../adr/0043-offline-scorm-runtime-and-local-progress-journal.md), [0044](../adr/0044-idempotent-offline-scorm-reconciliation.md)                                                                                                                                                     | Shell, dormant server boundaries and trusted local journal implemented; offline learning disabled     |
