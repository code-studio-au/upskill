...
for (const boundary of [
  ...
  "guard_offline_learning_installation",
  "Offline replacement requires an active installation for the same learner",
  "enforce_offline_learning_installation_consistency",
  "offline_learning_installation_consistency_trg",
  "offline_learning_entitlement_installation_consistency_trg",
  "Replaced offline installation requires an active successor",
  "Terminal offline installation cannot retain active entitlements",
  ...
  "enforce_offline_scorm_writer_consistency",
