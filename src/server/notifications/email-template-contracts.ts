...
const eventVariables = [
  ...
  emailVariable(
    "Event",
    "event.invitationUrl",
    "Personal event invitation link",
    "https://upskill.example/event-invitation#token=example",
    "url",
  ),
  emailVariable(
    "Event",
    "event.invitationExpiresAt",
    "Invitation expiry",
    "27 August 2026 at 5:00 pm",
  ),
  emailVariable(
    "Event",
    "event.reviewRegionName",
    "Regional review region",
    "Test North",
  ),
  emailVariable(
    "Event",
    "event.reviewPendingCount",
    "Registrations awaiting regional review",
    "3",
  ),
  emailVariable(
    "Event",
    "event.reviewRegistrationCount",
    "Registrations in regional list",
    "8",
  ),
  emailVariable(
    "Event",
    "event.reviewLockSource",
    "Regional list lock source",
...
const progressVariables = [
  ...
  emailVariable(
    "Progress",
    "progress.completedPostEventItemCount",
    "Completed post-event activity count",
    "1",
  ),
  emailVariable(
    "Progress",
    "progress.totalPostEventItemCount",
    "Total post-event activity count",
    "2",
  ),
  emailVariable(
    "Progress",
    "progress.remainingPostEventItemCount",
    "Remaining post-event activity count",
    "1",
  ),
];
